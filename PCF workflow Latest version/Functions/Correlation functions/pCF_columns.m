function [corrResult,corrBins]=pCF_columns(carpet1,radius,firstCol,lastCol,sampleFreq,ReverseOrder)
...
%If reverse order true will swap the columns for the correlation analysis 
