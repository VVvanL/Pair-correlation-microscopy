...
[distanceNames,corrBins,pCF_average_data] = calculate_pCF_variedDistCross(cropped_images_CH1,cropped_images_CH2,mfirstCol,mlastCol,sampleFreq,ReverseOrder);
...
MatrixSize   = size(cropped_images_CH1,1);
