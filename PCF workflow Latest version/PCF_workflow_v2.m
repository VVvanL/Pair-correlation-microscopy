...
radius = 8;                      % Set the value to 0 to get the ACF
...
%  Write 'ACF_carpet' as input into the function if you want to visualize ACF carpets 
%  Write 'PCF_carpet' as input into the function if you want to visualize pCF carpets 

avgData_S = plot_ACF_carpets_Smoothing_v9(PCF_carpet);
...
%% Return to Step 8 to get PCF data
...
pCF_Cell1=pCF_mean(:,3);
pCF_Cell2=pCF_mean(:,4);
pCF_Cell3=pCF_mean(:,5);
...
opts.StartPoint = [1.00990744438237e-05 -1.587 0.60]; % The main change should be performed here
...
opts2.StartPoint = [6.79402181078439e-06 -1.5 0.78];
...
opts3.StartPoint = [8.92366181560456e-06 -1.5 0.657];
